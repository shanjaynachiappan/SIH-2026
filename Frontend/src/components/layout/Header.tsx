  ...
  return (
    <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 flex items-center justify-between px-6 sticky top-0 z-40">
      <div className="flex items-center space-x-6 flex-1">
        ...
        <div className="relative max-w-md w-full hidden md:block">
          ...
          <input
            ...
            className="w-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 text-sm rounded-lg pl-10 pr-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 transition-shadow border-none"
          />
          <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center space-x-1">
            <span className="text-[10px] font-medium text-slate-400 dark:text-slate-500 border border-slate-300 dark:border-slate-700 rounded px-1.5 py-0.5">⌘</span>
            <span className="text-[10px] font-medium text-slate-400 dark:text-slate-500 border border-slate-300 dark:border-slate-700 rounded px-1.5 py-0.5">K</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-6">
        ...
        <button className="text-slate-400 hover:text-slate-600 dark:text-slate-300 dark:hover:text-slate-100 transition-colors relative">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {isProfileOpen && (
            <div className="absolute right-0 mt-3 w-48 bg-white rounded-xl shadow-lg border border-slate-200 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
              <button
